...
angular.module('auth').factory('authenticationService', ['$injector',
    function authenticationService($injector) {
         ...
         * "password" for the user's associated password + "yubikey" for the Yubikey String associated
         * to the user and "token" for the auth token to check/update.
         *
        ...
        /**
         * Makes a request to authenticate a user using the token REST API endpoint
         * with a username and password + yubikey, ignoring any currently-stored token,
         ...
         *     The generated yubikey String.
         *
         * @returns {Promise}
         *     A promise which succeeds only if the login operation was successful.
         */
        service.login = function login(username, password, yubikey) {
